...
def get_transformer_dataloaders(tokenizer, max_input_length, isTorch=True):
...
def process_nsp_dataset(dataset, tokenizer, max_input_length, column_name):
    """prepare dataset for next sentence generation
       sentence b is 50% next sentence of sentence a
    """
