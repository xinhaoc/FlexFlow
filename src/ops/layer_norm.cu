...
LayerNormMeta::LayerNormMeta(FFHandler handle,
  ...
  // <<<<<<< HEAD
  //   checkCUDA(
  //       cudaMalloc(&mean_ptr, data_type_size(data_type) *
  //       effective_batch_size));
  //   checkCUDA(
  //       cudaMalloc(&rstd_ptr, data_type_size(data_type) *
  //       effective_batch_size));
  //   checkCUDA(
  //       cudaMalloc(&ds_ptr, data_type_size(data_type) *
  //       effective_batch_size));
  //   checkCUDA(
  //       cudaMalloc(&db_ptr, data_type_size(data_type) *
  //       effective_batch_size));
  //   checkCUDA(
  //       cudaMalloc(&scale_ptr, data_type_size(data_type) *
  //       effective_batch_size));
  //   checkCUDA(
  //       cudaMalloc(&bias_ptr, data_type_size(data_type) *
  //       effective_batch_size));
  // =======
